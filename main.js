    ...
    function load () {
      ...
      return window.fetch(url)
        ...
        .then(function (data) { return ({
          coworking: data.filter(function (item) { return item.category === 'coworking'; }),
          hotDrinks: data.filter(function (item) { return item.category === 'hot-drink'; }),
          coldDrinks: data.filter(function (item) { return item.category === 'cold-drink'; }),
          extra: data.filter(function (item) { return item.category === 'extra'; })
        }); })
    }
});
